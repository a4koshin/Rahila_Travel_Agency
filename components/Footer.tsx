        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-100 text-sm leading-relaxed mt-4">
              Dedicated to creating unforgettable travel experiences through
              expert planning, personalized services, and seamless journeys
              across the globe.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 pb-2 border-b border-blue-100">
              Quick Links
            </h3>
        ...
        <div className="border-t border-blue-100 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-blue-200 text-sm text-center md:text-left">
              © {currentYear} Rahila Travel Agency. All rights reserved.
            </p>
